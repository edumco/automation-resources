...
## Specific to Java 8
 ...
 1. **Streams and Lambdas**: Use streams to manipulate collections and lambdas for concise and clear expressions.

## Specific to Test programming

 1. **Annotations**: Understand the use of annotations (@Override, @Deprecated, etc.), especially when using JUnit 5.
